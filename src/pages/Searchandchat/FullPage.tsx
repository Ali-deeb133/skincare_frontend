...
//         {/* <button
//           onClick={() => navigate(-1)}
//           className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#f0aecf] bg-white/70 backdrop-blur text-[#c0508a] hover:bg-[#fdf0f5] transition"
//         >
//           Back →
//         </button> */}
...
//         onClick={() => {
//           setIsChatOpen(true);
//           setTimeout(() => setAnimateChat(true), 50);
//         }}
